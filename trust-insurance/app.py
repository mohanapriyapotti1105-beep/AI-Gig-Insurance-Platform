...
# API_KEY = "f7b4a3d88337ad2894d3aefc138bf5d0"  # keep your key here
...
#     anomaly = random.choice([False, False, False, True])  # less anomalies
...
#     return score, activity, gps_variation, anomaly
...
#         trust_score, activity, gps, anomaly = calculate_trust()

#         # 🎯 Smart Decision Logic (UPDATED)
